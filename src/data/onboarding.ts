...
export const onboardingSteps: OnboardingStep[] = [
  {
    ...
    questionForCommunity:
      "Koji problem s novcem ti je najbliži iz svakodnevnog života?",
  },
  {
  ...
  },
  {
    ...
    doNotDo: [
      "Ne miješaj početno učenje Bitcoina s lovom na nove tokene.",
      "Ne koristi grupu za trading signale.",
    ],
    questionForCommunity:
      "Koju razliku između Bitcoina i 'crypto' priče želiš bolje razumjeti?",
  ...
  },
  {
    ...
    shortText:
      "Privatni ključ je kontrola nad sredstvima, ne lozinka za dijeljenje.",
    explanation:
    ...
    doNotDo: [
      "Ne šalji privatni ključ nikome.",
      "Ne upisuj privatni ključ u web stranice koje ne razumiješ.",
    ],
    questionForCommunity:
      "Kako provjeriti razliku između javne adrese i privatnog ključa?",
  ...
  },
  {
    ...
    questionForCommunity:
      "Koje su sigurne offline metode za backup seed phrasea?",
    safetyLevel: "critical",
  },
  {
    title: "Zašto ne držati sve na exchangeu?",
    shortText:
      "Nauči razliku između računa kod posrednika i vlastitog skrbništva.",
    explanation:
    ...
    doNotDo: [
      "Ne prebacuj velike iznose prije nego što razumiješ postupak.",
      "Ne preskači testne male transakcije.",
    ],
    questionForCommunity:
      "Kako sigurno vježbati withdrawal bez nepotrebnog rizika?",
    safetyLevel: "important",
  },
  {
    ...
    doNotDo: [
      "Ne vjeruj garantiranim povratima.",
      "Ne klikaj linkove iz privatnih poruka bez provjere.",
      "Ne šalji podatke lažnom supportu.",
    ],
    questionForCommunity:
      "Kako provjeriti sumnjiv link ili poruku bez otkrivanja privatnih podataka?",
    safetyLevel: "critical",
  },
  {
    ...
    doNotDo: [
      "Ne kupuj uređaje iz sumnjivih izvora.",
      "Ne koristi unaprijed pripremljen seed phrase.",
    ],
    questionForCommunity:
      "Koje pojmove treba razumjeti prije kupnje hardware walleta?",
    safetyLevel: "important",
  },
  {
    ...
    questionForCommunity:
      "Koja je razlika između custodial i non-custodial Lightning walleta?",
  },
  {
    title: "Što je node?",
    shortText:
      "Node provjerava pravila Bitcoina umjesto da vjeruje tuđem servisu.",
    explanation:
  ...
  },
  {
    ...
    doNotDo: [
      "Ne prelazi na self-custody bez razumijevanja backupa.",
      "Ne improviziraj s velikim iznosima.",
    ],
    questionForCommunity:
      "Kako izgleda jednostavna self-custody procedura za početnike?",
    safetyLevel: "important",
  },
  {
    ...
    doNotDo: [
      "Ne objavljuj javno iznose koje držiš.",
      "Ne povezuj nepotrebno identitet, adrese i transakcije.",
    ],
    questionForCommunity:
      "Koje privatne podatke početnik često slučajno podijeli?",
    safetyLevel: "important",
  },
  {
    title: "Što ne pitati u javnoj grupi?",
    shortText:
      "Ne dijeli iznose, seed phrase, privatne podatke ni osjetljive planove.",
    explanation:
    ...
    doNotDo: [
      "Ne dijeli seed phrase.",
      "Ne dijeli koliko bitcoina imaš.",
      "Ne objavljuj osobne dokumente ili privatne kontakte.",
    ],
    questionForCommunity:
      "Kako formulirati sigurnosno pitanje bez otkrivanja privatnih detalja?",
    safetyLevel: "critical",
  },
  {
    title: "Kako sigurno doći na meetup?",
    shortText:
      "Koristi javne najave, provjeri lokaciju i ne nosi nepotrebne informacije.",
    explanation:
    ...
    doNotDo: [
      "Ne nosi seed phrase.",
      "Ne otkrivaj iznose.",
      "Ne dogovaraj privatne financijske razmjene s nepoznatim osobama.",
    ],
  ...
  },
  {
    ...
    doNotDo: [
      "Ne obećavaj zaradu.",
      "Ne požuruj nikoga na kupnju.",
      "Ne koristi strah kao argument.",
    ],
  ...
  },
  {
    ...
    questionForCommunity:
      "Koja pitanja poduzetnik treba postaviti prije primanja bitcoina?",
  },
  {
    title: "Bitcoin i dugoročna štednja.",
    shortText:
      "Ovo nije poziv na kupnju, nego tema za razumijevanje novca kroz vrijeme.",
    explanation:
    ...
    doNotDo: [
      "Ne ulaži novac koji ne razumiješ ili koji ti treba za osnovne obaveze.",
      "Ne donosi odluke zbog tuđe panike ili euforije.",
    ],
    questionForCommunity:
      "Kako razlikovati učenje o štednji od investicijskog savjeta?",
    safetyLevel: "important",
  },
  {
    title: "Najčešći mitovi.",
    shortText:
      "Provjeri tvrdnje, izvore i razliku između kritike i površnog naslova.",
    explanation:
    ...
    questionForCommunity:
      "Koji mit o Bitcoinu želiš provjeriti iz više izvora?",
  },
  {
