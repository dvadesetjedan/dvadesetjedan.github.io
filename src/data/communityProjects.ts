...
export const communityProjects: CommunityProject[] = [
  ...
  },
  {
    ...
    displayName: "Bitcoin Diploma prijevod",
    personName: "Dalibor",
    category: "translation",
    secondaryCategories: ["education"],
    summary:
      "Prijevod Bitcoin Diploma edukacijskog programa za ljude koji žele učiti Bitcoin na našem jeziku.",
    description: [
      "Bitcoin Diploma je edukacijski program inicijative My First Bitcoin.",
      "Dalibor, član DvadesetJedan zajednice, radi na tome da Bitcoin Diploma materijali budu dostupni na našem jeziku.",
      "Cilj je približiti strukturirano Bitcoin obrazovanje ljudima iz regije i olakšati buduće radionice, škole ili lokalne edukacijske susrete.",
    ],
    status: "active",
    relationship: "member-project",
    tags: [
