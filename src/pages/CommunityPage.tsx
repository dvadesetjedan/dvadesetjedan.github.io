  ...
  return (
    <Layout>
      <main className="mx-auto max-w-7xl px-5 pb-16 pt-12 sm:px-8 sm:pt-16">
        ...
        <PageHero
          eyebrow="Zajednica"
          title="Otvoreni Bitcoin prostor za regiju."
          intro="Telegram služi za razgovor i koordinaciju, YouTube za javni signal, a događaji za susrete uživo. Fokus ostaje Bitcoin-only: bez tradinga, bez tokena, bez obećanja zarade."
        />
